...
private fun findLocalArtifact(group: String, artifact: String)
    =  tryFindingLocalArtifactUsing(artifact, findLocalArtifactDirUsingMaven(group, artifact))
    ?: tryFindingLocalArtifactUsing(artifact, findLocalArtifactDirUsingGradle(group, artifact))
...
private fun tryFindingLocalArtifactUsing( artifact: String, artifactDirResolution: LocalArtifactDirectoryResolution): Path? {
    ...
    if(artifactDirResolution.artifactDir==null) return null;
